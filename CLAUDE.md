...
- F009 Kronos 服务生命周期控制面端点（v0.2, ready-for-development）→ `docs/features/0.2/F009-kronos-lifecycle-endpoints/`
- F010 Kronos GPU 推理基座（v0.2, doc-reviewing）→ `docs/features/0.2/F010-kronos-gpu-runtime/`
